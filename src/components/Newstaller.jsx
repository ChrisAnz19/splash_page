...
const Newstaller = () => {
  ...
  return (
    <section
      className="rounded-b-[90px] mt-[120px] md:mt-[350px] pb-20 md:pb-[122px] pt-[50px] sm:pt-[125px] relative z-[10]"
      style={{
    ...
    >
      <img
        ...
        width={1602}
        height={1602}
        className="absolute top-[-50px] sm:top-[-100px] md:top-[-20%] left-0 w-full"
      />
      <div id="waitlist" className="mx-auto container relative z-10">
        <h3 className="text-5xl leading-[60px] md:text-[60px] md:leading-[1.4] lg:text-[90px] lg:leading-[110px] font-bold max-w-[524px] mx-auto text-center mb-10">
        ...
        <div className="flex flex-col gap-5 mx-auto max-w-[818px]">
          <div className="relative">
            ...
            <span className="absolute top-3 lg:text-lg end-0 text-[#818181]">
              01
            </span>
          </div>
          <div className="relative">
